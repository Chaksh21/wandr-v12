  ...
  install: function(inst){
    ...
    inst.rvSetup = function(c){
      ...
      return {
        ...
        tasks,
        tripCode:t.code, destName: (V==='setup' ? funnelDest.name : dest.name), suMapPins, contributors, contributorsSummary, lockedLabel, invite:()=>this.setState({ suScreen:'sPeople', suEditReturn:'s8', suPeopleBack:'s8' }),
        ...
        lockAndGo:()=>{ if (!suPicked){ this.toast('Tap a draft to select it first'); return; } this.suCreateTrip(); this.setState({ suEditReturn:'s8', suPeopleBack:'s12' }); this.suNav('sPeople'); },
      };
    };
